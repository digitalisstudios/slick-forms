...
@section('content')
    {{-- Reuse the full builder with Form Settings opened to expose all tabs/options --}}
    <livewire:slick-forms::form-builder :form-id="$form->id" :open-form-settings="true" :settings-only="true" />
@endsection

@section('modals')
    {{-- Make Template Modal (parity with builder actions) --}}
