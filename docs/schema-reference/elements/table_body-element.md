...
| `element_type` | `string` | Yes | - | Must be 'table_section' for this element type |
...
- Must be 'table_section' for this element type
...
{
    "slick_form_id": 1,
    "element_type": "table_section",
    "element_id": "table_section-element",
    "order": 0
}
```
...
```json
{
    ...
    "properties": {
        ...
        "element_type": {
            ...
            "storage": "column",
            "value": "table_section",
            "description": "Must be 'table_section' for this element type"
        },
        "order": {
            "type": "integer",
            "required": true,
