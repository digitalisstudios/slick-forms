...
| `element_type` | `string` | Yes | - | Must be 'card' for this element type |
...
| `header` | `text` | No | - | Leave empty for no header |
| `title` | `text` | No | - | Card Title |
| `subtitle` | `text` | No | - | Card Subtitle |
| `footer` | `text` | No | - | Leave empty for no footer |
| `background` | `select` | No | `""` | Background Color |
| `border` | `select` | No | `""` | Border Color |
| `shadow` | `select` | No | `""` | Shadow |
...
- Must be 'card' for this element type
...
```json
{
    ...
    "properties": {
        ...
        "element_type": {
            ...
            "storage": "column",
            "value": "card",
            "description": "Must be 'card' for this element type"
        },
        "order": {
            "type": "integer",
            "required": true,
        ...
        "footer": {
            ...
            "storage": "json_column",
            "default": null,
            "description": "Leave empty for no footer",
            "tab": "settings"
        },
        "background": {
            "type": "select",
