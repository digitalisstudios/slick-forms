...
| `element_type` | `string` | Yes | - | Must be 'tab' for this element type |
...
| `tab_title` | `text` | No | - | Tab Title |
| `tab_icon` | `icon_picker` | No | - | Tab Icon |
...
- Must be 'tab' for this element type
...
```json
{
    ...
    "properties": {
        ...
        "element_type": {
            ...
            "storage": "column",
            "value": "tab",
            "description": "Must be 'tab' for this element type"
        },
        "order": {
            "type": "integer",
            "required": true,
