...
| `element_type` | `string` | Yes | - | Must be 'table_row' for this element type |
...
- Must be 'table_row' for this element type
...
```json
{
    ...
    "properties": {
        ...
        "element_type": {
            ...
            "storage": "column",
            "value": "table_row",
            "description": "Must be 'table_row' for this element type"
        },
        "order": {
            "type": "integer",
            "required": true,
