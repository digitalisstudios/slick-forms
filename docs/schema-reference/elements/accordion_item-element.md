...
| `element_type` | `string` | Yes | - | Must be 'accordion_item' for this element type |
...
| `item_title` | `text` | No | - | Item Title |
| `item_icon` | `icon_picker` | No | - | Item Icon |
...
- Must be 'accordion_item' for this element type
...
```json
{
    ...
    "properties": {
        ...
        "element_type": {
            ...
            "description": "Must be 'accordion_item' for this element type"
        },
        "order": {
            "type": "integer",
            "required": true,
