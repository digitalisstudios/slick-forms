...
| `element_type` | `string` | Yes | - | Must be 'row' for this element type |
...
| `gutter` | `select` | No | `""` | Space between columns |
| `horizontal_alignment` | `select` | No | `""` | Horizontal distribution of columns |
| `vertical_alignment` | `select` | No | `""` | Vertical alignment of columns |
...
- Must be 'row' for this element type
...
```json
{
    ...
    "properties": {
        ...
        "element_type": {
            ...
            "storage": "column",
            "value": "row",
            "description": "Must be 'row' for this element type"
        },
        "order": {
            "type": "integer",
            "required": true,
        ...
        "horizontal_alignment": {
            ...
            "storage": "json_column",
            "default": "",
            "description": "Horizontal distribution of columns",
            "options": [
                "Start (default)",
                "Center",
                "End",
