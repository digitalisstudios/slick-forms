...
| `element_type` | `string` | Yes | - | Must be 'table' for this element type |
...
| `label` | `text` | No | - | Optional label shown above the table |
| `columns` | `number` | No | `2` | Number of columns in the table |
| `striped` | `switch` | No | `false` | Alternate row colors for easier reading |
| `bordered` | `switch` | No | `true` | Add borders around table cells |
| `borderless` | `switch` | No | `false` | Remove all borders (overrides bordered) |
| `hover` | `switch` | No | `false` | Highlight rows on hover |
| `size` | `select` | No | `""` | Table Size |
| `responsive` | `switch` | No | `true` | Enable horizontal scrolling on small screens |
...
- Must be 'table' for this element type
...
**`borderless`**
- Remove all borders (overrides bordered)
...
```json
{
    ...
    "properties": {
        ...
        "element_type": {
            ...
            "storage": "column",
            "value": "table",
            "description": "Must be 'table' for this element type"
        },
        "order": {
            "type": "integer",
            "required": true,
        ...
        "striped": {
            ...
            "storage": "json_column",
            "default": false,
            "description": "Alternate row colors for easier reading",
            "tab": "style"
        },
        "bordered": {
            "type": "switch",
            ...
            "storage": "json_column",
            "default": true,
            "description": "Add borders around table cells",
            "tab": "style"
        },
        "borderless": {
            "type": "switch",
            ...
            "storage": "json_column",
            "default": false,
            "description": "Remove all borders (overrides bordered)",
            "tab": "style"
        },
        "hover": {
            "type": "switch",
        ...
        "responsive": {
            ...
            "storage": "json_column",
            "default": true,
            "description": "Enable horizontal scrolling on small screens",
            "tab": "settings"
        }
    },
    "allowed_children": [
