...
| `field_type` | `string` | Yes | - | Must be 'time' for this field type |
...
| `enable_24_hour` | `switch` | No | `false` | Use 24-hour time format (13:00) instead of 12-hour (1:00 PM) |
| `show_seconds` | `switch` | No | `false` | Allow selection of seconds in addition to hours and minutes |
...
**`field_type`** *(required)*
- Must be 'time' for this field type
...
**`enable_24_hour`**
- Use 24-hour time format (13:00) instead of 12-hour (1:00 PM)

**`show_seconds`**
- Allow selection of seconds in addition to hours and minutes
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "time",
            "description": "Must be 'time' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "enable_24_hour": {
            ...
            "storage": "json_column",
            "default": false,
            "description": "Use 24-hour time format (13:00) instead of 12-hour (1:00 PM)",
            "tab": "options"
        },
        "show_seconds": {
            "type": "switch",
            ...
            "storage": "json_column",
            "default": false,
            "description": "Allow selection of seconds in addition to hours and minutes",
            "tab": "options"
        }
    },
    "validation_rules": {
