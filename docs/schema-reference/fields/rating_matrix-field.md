...
| `field_type` | `string` | Yes | - | Must be 'rating_matrix' for this field type |
...
| `rows` | `repeater` | No | `[{"value":"row1","label":"Item 1"},{"value":"row2","label":"Item 2"},{"value":"row3","label":"Item 3"}]` | Items to be rated (rows in the matrix) |
| `columns` | `repeater` | No | `[{"value":"1","label":"1"},{"value":"2","label":"2"},{"value":"3","label":"3"},{"value":"4","label":"4"},{"value":"5","label":"5"}]` | Rating scale options (columns in the matrix) |
| `input_type` | `select` | No | `"radio"` | How users select their ratings |
| `allow_na` | `switch` | No | `false` | Add a "Not Applicable" option for each row |
...
**`field_type`** *(required)*
- Must be 'rating_matrix' for this field type
...
**`rows`**
- Items to be rated (rows in the matrix)

**`columns`**
- Rating scale options (columns in the matrix)

**`input_type`**
- How users select their ratings
- Options: 
  - `0`: Radio Buttons (Traditional Matrix)
  - `1`: Dropdown Select (Mobile Friendly)

**`allow_na`**
- Add a "Not Applicable" option for each row
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "rating_matrix",
            "description": "Must be 'rating_matrix' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "rows": {
            ...
            "description": "Items to be rated (rows in the matrix)",
            "tab": "options"
        },
        "columns": {
            "type": "repeater",
            ...
            "description": "Rating scale options (columns in the matrix)",
            "tab": "options"
        },
        "input_type": {
            "type": "select",
            ...
            "storage": "json_column",
            "default": "radio",
            "description": "How users select their ratings",
            "options": [
                "Radio Buttons (Traditional Matrix)",
                "Dropdown Select (Mobile Friendly)"
            ],
            "options_labels": {
        ...
        "allow_na": {
            ...
            "storage": "json_column",
            "default": false,
            "description": "Add a \"Not Applicable\" option for each row",
            "tab": "options"
        }
    },
    "validation_rules": {
