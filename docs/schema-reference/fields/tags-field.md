...
| `field_type` | `string` | Yes | - | Must be 'tags' for this field type |
...
| `max_tags` | `number` | No | - | Maximum number of tags allowed (leave empty for unlimited) |
...
**`field_type`** *(required)*
- Must be 'tags' for this field type
...
**`max_tags`**
- Maximum number of tags allowed (leave empty for unlimited)
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "tags",
            "description": "Must be 'tags' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "max_tags": {
            ...
            "storage": "json_column",
            "default": null,
            "description": "Maximum number of tags allowed (leave empty for unlimited)",
            "tab": "options"
        }
    },
    "validation_rules": {
