...
| `field_type` | `string` | Yes | - | Must be 'number' for this field type |
...
| `min` | `number` | No | - | Minimum value allowed (HTML5 validation) |
| `max` | `number` | No | - | Maximum value allowed (HTML5 validation) |
| `step` | `number` | No | `1` | Increment step (e.g., 0.01 for decimals, 1 for integers) |
...
**`field_type`** *(required)*
- Must be 'number' for this field type
...
**`min`**
- Minimum value allowed (HTML5 validation)

**`max`**
- Maximum value allowed (HTML5 validation)

**`step`**
- Increment step (e.g., 0.01 for decimals, 1 for integers)
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "number",
            "description": "Must be 'number' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "min": {
            ...
            "storage": "json_column",
            "default": null,
            "description": "Minimum value allowed (HTML5 validation)",
            "tab": "options"
        },
        "max": {
            "type": "number",
            ...
            "storage": "json_column",
            "default": null,
            "description": "Maximum value allowed (HTML5 validation)",
            "tab": "options"
        },
        "step": {
            "type": "number",
            ...
            "storage": "json_column",
            "default": 1,
            "description": "Increment step (e.g., 0.01 for decimals, 1 for integers)",
            "tab": "options"
        },
        "mask_enabled": {
            "type": "switch",
    ...
    "validation_rules": {
        ...
        "available_rules": {
            ...
            "integer": {
                "format": "integer",
                "description": "Must be Integer (No Decimals)",
                "help": "",
                "value_type": "checkbox",
                "placeholder": null
            },
