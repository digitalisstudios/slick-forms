...
| `field_type` | `string` | Yes | - | Must be 'email' for this field type |
...
**`field_type`** *(required)*
- Must be 'email' for this field type
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "email",
            "description": "Must be 'email' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
    ...
    "validation_rules": {
        ...
        "available_rules": {
            "email:rfc": {
                "format": "email:rfc",
                "description": "Strict RFC Compliance",
