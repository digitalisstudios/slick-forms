...
| `field_type` | `string` | Yes | - | Must be 'location' for this field type |
...
| `default_lat` | `number` | No | `37.7749` | Default map center latitude (e.g., 37.7749 for San Francisco) |
| `default_lng` | `number` | No | `-122.4194` | Default map center longitude (e.g., -122.4194 for San Francisco) |
| `default_zoom` | `number` | No | `13` | Map zoom level (1 = world view, 18 = street level) |
| `map_height` | `number` | No | `400` | Height of the map in pixels |
| `enable_search` | `switch` | No | `true` | Show search box to find locations by address |
| `show_coordinates` | `switch` | No | `true` | Display latitude and longitude below the map |
...
**`field_type`** *(required)*
- Must be 'location' for this field type
...
**`default_lat`**
- Default map center latitude (e.g., 37.7749 for San Francisco)

**`default_lng`**
- Default map center longitude (e.g., -122.4194 for San Francisco)

**`default_zoom`**
- Map zoom level (1 = world view, 18 = street level)

**`map_height`**
- Height of the map in pixels

**`enable_search`**
- Show search box to find locations by address

**`show_coordinates`**
- Display latitude and longitude below the map
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "location",
            "description": "Must be 'location' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "default_lat": {
            ...
            "storage": "json_column",
            "default": 37.7749,
            "description": "Default map center latitude (e.g., 37.7749 for San Francisco)",
            "tab": "options"
        },
        "default_lng": {
            "type": "number",
            ...
            "storage": "json_column",
            "default": -122.4194,
            "description": "Default map center longitude (e.g., -122.4194 for San Francisco)",
            "tab": "options"
        },
        "default_zoom": {
            "type": "number",
        ...
        "enable_search": {
            ...
            "storage": "json_column",
            "default": true,
            "description": "Show search box to find locations by address",
            "tab": "options"
        },
        "show_coordinates": {
            "type": "switch",
            ...
            "storage": "json_column",
            "default": true,
            "description": "Display latitude and longitude below the map",
            "tab": "options"
        }
    },
    "validation_rules": {
