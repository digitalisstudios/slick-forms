...
| `field_type` | `string` | Yes | - | Must be 'select' for this field type |
...
| `values` | `options` | Yes | `[{"label":"Option 1","value":"1","default":false},{"label":"Option 2","value":"2","default":false},{"label":"Option 3","value":"3","default":false}]` | Define the available dropdown options |
| `source_url` | `text` | No | - | URL to fetch options from (use {parent} for cascading) |
| `headers` | `textarea` | No | - | JSON object of headers to include in request |
| `value_key` | `text` | No | `"value"` | JSON path to value field (e.g., "id" or "data.id") |
| `label_key` | `text` | No | `"label"` | JSON path to label field (e.g., "name" or "data.name") |
| `model_class` | `text` | No | - | Fully qualified model class (e.g., App\Models\Country) |
| `value_column` | `text` | No | `"id"` | Database column for option value |
| `label_column` | `text` | No | `"name"` | Database column for option label |
| `scope` | `text` | No | - | Optional scope method name (e.g., "active") |
| `where_conditions` | `textarea` | No | - | JSON object of where conditions (e.g., {"status": "active"}) |
| `multiple` | `switch` | No | `false` | Allow users to select multiple options |
| `searchable` | `switch` | No | `false` | Add search functionality using Tom Select |
| `search_placeholder` | `text` | No | `"Search options..."` | Placeholder text for the search input |
...
**`field_type`** *(required)*
- Must be 'select' for this field type
...
**`values`** *(required)*
- Define the available dropdown options

**`source_url`**
- URL to fetch options from (use {parent} for cascading)

**`headers`**
- JSON object of headers to include in request

**`value_key`**
- JSON path to value field (e.g., "id" or "data.id")

**`label_key`**
- JSON path to label field (e.g., "name" or "data.name")

**`model_class`**
- Fully qualified model class (e.g., App\Models\Country)
...
**`scope`**
- Optional scope method name (e.g., "active")

**`where_conditions`**
- JSON object of where conditions (e.g., {"status": "active"})

**`multiple`**
- Allow users to select multiple options

**`searchable`**
- Add search functionality using Tom Select
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "select",
            "description": "Must be 'select' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "values": {
            ...
            "description": "Define the available dropdown options",
            "tab": "options"
        },
        "source_url": {
            "type": "text",
            ...
            "storage": "json_column",
            "default": null,
            "description": "URL to fetch options from (use {parent} for cascading)",
            "tab": "options"
        },
        "headers": {
            "type": "textarea",
            ...
            "storage": "json_column",
            "default": null,
            "description": "JSON object of headers to include in request",
            "tab": "options"
        },
        "value_key": {
            "type": "text",
            ...
            "storage": "json_column",
            "default": "value",
            "description": "JSON path to value field (e.g., \"id\" or \"data.id\")",
            "tab": "options"
        },
        "label_key": {
            "type": "text",
            ...
            "storage": "json_column",
            "default": "label",
            "description": "JSON path to label field (e.g., \"name\" or \"data.name\")",
            "tab": "options"
        },
        "model_class": {
            "type": "text",
            ...
            "storage": "json_column",
            "default": null,
            "description": "Fully qualified model class (e.g., App\\Models\\Country)",
            "tab": "options"
        },
        "value_column": {
            "type": "text",
        ...
        "scope": {
            ...
            "storage": "json_column",
            "default": null,
            "description": "Optional scope method name (e.g., \"active\")",
            "tab": "options"
        },
        "where_conditions": {
            "type": "textarea",
            ...
            "storage": "json_column",
            "default": null,
            "description": "JSON object of where conditions (e.g., {\"status\": \"active\"})",
            "tab": "options"
        },
        "multiple": {
            "type": "switch",
        ...
        "searchable": {
            ...
            "storage": "json_column",
            "default": false,
            "description": "Add search functionality using Tom Select",
            "tab": "options"
        },
        "search_placeholder": {
            "type": "text",
