...
| `field_type` | `string` | Yes | - | Must be 'url' for this field type |
...
| `show_preview` | `switch` | No | `false` | Display a button to open and preview the entered URL |
| `open_in_new_tab` | `switch` | No | `true` | Open link preview in a new browser tab |
| `mask_enabled` | `switch` | No | `true` | Auto-format the URL as users type |
| `mask_type` | `select` | No | `"https_only"` | Use a custom input pattern for the URL format |
| `mask_pattern` | `text` | No | `""` | # = number, A = letter, * = alphanumeric. Example: https://AAA.***.com/*** |
...
**`field_type`** *(required)*
- Must be 'url' for this field type
...
**`show_preview`**
- Display a button to open and preview the entered URL

**`open_in_new_tab`**
- Open link preview in a new browser tab

**`mask_enabled`**
- Auto-format the URL as users type

**`mask_type`**
- Use a custom input pattern for the URL format
- Options: 
  - `0`: None
  - `1`: Slug (a-z, 0-9, hyphen)
  - `2`: HTTPS only (force https://)
  - `3`: Custom Pattern

**`mask_pattern`**
- # = number, A = letter, * = alphanumeric. Example: https://AAA.***.com/***
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "url",
            "description": "Must be 'url' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "show_preview": {
            ...
            "storage": "json_column",
            "default": false,
            "description": "Display a button to open and preview the entered URL",
            "tab": "options"
        },
        "open_in_new_tab": {
            "type": "switch",
            ...
            "storage": "json_column",
            "default": true,
            "description": "Open link preview in a new browser tab",
            "tab": "options"
        },
        "mask_enabled": {
            "type": "switch",
            ...
            "storage": "json_column",
            "default": true,
            "description": "Auto-format the URL as users type",
            "tab": "options"
        },
        "mask_type": {
            "type": "select",
            ...
            "storage": "json_column",
            "default": "https_only",
            "description": "Use a custom input pattern for the URL format",
            "options": [
                "None",
                "Slug (a-z, 0-9, hyphen)",
        ...
        "mask_pattern": {
            ...
            "storage": "json_column",
            "default": "",
            "description": "# = number, A = letter, * = alphanumeric. Example: https:\/\/AAA.***.com\/***",
            "tab": "options"
        }
    },
    "validation_rules": {
