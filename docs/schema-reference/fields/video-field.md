...
| `field_type` | `string` | Yes | - | Must be 'video' for this field type |
...
| `video_type` | `select` | No | `"url"` | Video Type |
| `video_url` | `textarea` | No | - | Enter a direct video URL or paste embed code from YouTube/Vimeo |
| `width` | `text` | No | `"100%"` | Only applies to direct video URLs |
| `height` | `text` | No | `"400px"` | Only applies to direct video URLs |
...
**`field_type`** *(required)*
- Must be 'video' for this field type
...
- Options: 
  - `0`: Direct Video URL
  - `1`: Embed Code (YouTube, Vimeo, etc.)

**`video_url`**
- Enter a direct video URL or paste embed code from YouTube/Vimeo
...
**`width`**
- Only applies to direct video URLs
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "video",
            "description": "Must be 'video' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "video_url": {
            ...
            "storage": "json_column",
            "default": null,
            "description": "Enter a direct video URL or paste embed code from YouTube\/Vimeo",
            "tab": "basic"
        },
        "width": {
            "type": "text",
            ...
            "storage": "json_column",
            "default": "100%",
            "description": "Only applies to direct video URLs",
            "tab": "options"
        },
        "height": {
            "type": "text",
