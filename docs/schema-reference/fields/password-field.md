...
| `field_type` | `string` | Yes | - | Must be 'password' for this field type |
...
| `show_toggle` | `switch` | No | `true` | Allow users to toggle password visibility |
| `show_strength` | `switch` | No | `true` | Display real-time password strength meter |
| `minimum_strength` | `number` | No | `4` | Minimum password strength (0 = no requirement, 1 = very weak, 5 = strong) |
...
**`field_type`** *(required)*
- Must be 'password' for this field type
...
**`show_strength`**
- Display real-time password strength meter

**`minimum_strength`**
- Minimum password strength (0 = no requirement, 1 = very weak, 5 = strong)
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "password",
            "description": "Must be 'password' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "show_toggle": {
            ...
            "storage": "json_column",
            "default": true,
            "description": "Allow users to toggle password visibility",
            "tab": "options"
        },
        "show_strength": {
            "type": "switch",
            ...
            "storage": "json_column",
            "default": true,
            "description": "Display real-time password strength meter",
            "tab": "options"
        },
        "minimum_strength": {
            "type": "number",
            ...
            "storage": "json_column",
            "default": 4,
            "description": "Minimum password strength (0 = no requirement, 1 = very weak, 5 = strong)",
            "tab": "options"
        }
    },
    "validation_rules": {
