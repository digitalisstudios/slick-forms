...
| `field_type` | `string` | Yes | - | Must be 'range' for this field type |
...
| `min` | `number` | No | `"0"` | Minimum value for the range |
| `max` | `number` | No | `"100"` | Maximum value for the range |
| `step` | `number` | No | `"1"` | Increment/decrement step for both sliders |
...
**`field_type`** *(required)*
- Must be 'range' for this field type
...
**`step`**
- Increment/decrement step for both sliders
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "range",
            "description": "Must be 'range' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "step": {
            ...
            "storage": "json_column",
            "default": "1",
            "description": "Increment\/decrement step for both sliders",
            "tab": "options"
        }
    },
    "validation_rules": {
