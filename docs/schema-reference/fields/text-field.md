...
| `field_type` | `string` | Yes | - | Must be 'text' for this field type |
...
| `mask_pattern` | `text` | No | `""` | # = number, A = letter, * = alphanumeric. Example: ###-##-#### for SSN |
...
**`field_type`** *(required)*
- Must be 'text' for this field type
...
**`mask_pattern`**
- # = number, A = letter, * = alphanumeric. Example: ###-##-#### for SSN
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "text",
            "description": "Must be 'text' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "mask_pattern": {
            ...
            "storage": "json_column",
            "default": "",
            "description": "# = number, A = letter, * = alphanumeric. Example: ###-##-#### for SSN",
            "tab": "options"
        }
    },
    "validation_rules": {
        ...
        "available_rules": {
            ...
            "alpha_dash": {
                "format": "alpha_dash",
                "description": "Allow Letters, Numbers, Dashes, Underscores",
                "help": "",
                "value_type": "checkbox",
                "placeholder": null
            }
