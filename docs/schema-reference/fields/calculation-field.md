...
| `field_type` | `string` | Yes | - | Must be 'calculation' for this field type |
...
| `formula` | `textarea` | Yes | - | Use {field_name} to reference other fields. Example: {price} * {quantity} |
| `display_as` | `select` | No | `"number"` | Display Format |
| `decimal_places` | `number` | No | `2` | Number of decimal places to display |
| `prefix` | `text` | No | - | Text to show before the value (e.g., $) |
| `suffix` | `text` | No | - | Text to show after the value (e.g., %) |
| `display_mode` | `select` | No | `"visible"` | Hidden fields will store the value but not display it |
...
**`field_type`** *(required)*
- Must be 'calculation' for this field type
...
**`formula`** *(required)*
- Use {field_name} to reference other fields. Example: {price} * {quantity}
...
**`suffix`**
- Text to show after the value (e.g., %)

**`display_mode`**
- Hidden fields will store the value but not display it
- Options: 
  - `0`: Visible
  - `1`: Hidden
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "calculation",
            "description": "Must be 'calculation' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "formula": {
            ...
            "storage": "json_column",
            "default": null,
            "description": "Use {field_name} to reference other fields. Example: {price} * {quantity}",
            "tab": "options"
        },
        "display_as": {
            "type": "select",
        ...
        "suffix": {
            ...
            "storage": "json_column",
            "default": null,
            "description": "Text to show after the value (e.g., %)",
            "tab": "options"
        },
        "display_mode": {
            "type": "select",
            ...
            "storage": "json_column",
            "default": "visible",
            "description": "Hidden fields will store the value but not display it",
            "options": [
                "Visible",
                "Hidden"
            ],
