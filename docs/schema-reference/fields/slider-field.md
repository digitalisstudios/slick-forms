...
| `field_type` | `string` | Yes | - | Must be 'slider' for this field type |
...
| `step` | `number` | No | `"1"` | Slider increment/decrement step |
| `show_value` | `switch` | No | `true` | Display the current slider value |
...
**`field_type`** *(required)*
- Must be 'slider' for this field type
...
**`step`**
- Slider increment/decrement step
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "slider",
            "description": "Must be 'slider' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "step": {
            ...
            "storage": "json_column",
            "default": "1",
            "description": "Slider increment\/decrement step",
            "tab": "options"
        },
        "show_value": {
            "type": "switch",
