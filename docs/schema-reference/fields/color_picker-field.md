...
| `field_type` | `string` | Yes | - | Must be 'color_picker' for this field type |
...
| `default_color` | `color` | No | `"#000000"` | Pre-selected color value |
| `show_hex` | `switch` | No | `true` | Display text input for hex color codes |
...
**`field_type`** *(required)*
- Must be 'color_picker' for this field type
...
**`show_hex`**
- Display text input for hex color codes
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "color_picker",
            "description": "Must be 'color_picker' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "default_color": {
            ...
            "storage": "json_column",
            "default": "#000000",
            "description": "Pre-selected color value",
            "tab": "options"
        },
        "show_hex": {
            "type": "switch",
            ...
            "storage": "json_column",
            "default": true,
            "description": "Display text input for hex color codes",
            "tab": "options"
        }
    },
    "validation_rules": {
