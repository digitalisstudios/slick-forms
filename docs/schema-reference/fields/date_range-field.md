...
| `field_type` | `string` | Yes | - | Must be 'date_range' for this field type |
...
**`field_type`** *(required)*
- Must be 'date_range' for this field type
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "date_range",
            "description": "Must be 'date_range' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
    ...
    "validation_rules": {
        ...
        "available_rules": {
            "start_after": {
                "format": "start_after:{value}",
                "description": "Start Date Must Be After",
                "help": "Start date must be after this date",
                "value_type": "date",
                "placeholder": "YYYY-MM-DD"
            },
            "start_before": {
                "format": "start_before:{value}",
                "description": "Start Date Must Be Before",
                "help": "Start date must be before this date",
                "value_type": "date",
                "placeholder": "YYYY-MM-DD"
            },
            "max_duration_days": {
                "format": "max_duration_days:{value}",
                "description": "Maximum Duration (Days)",
                "help": "Maximum number of days between start and end date",
                "value_type": "number",
                "placeholder": "30"
            },
            "min_duration_days": {
                "format": "min_duration_days:{value}",
                "description": "Minimum Duration (Days)",
