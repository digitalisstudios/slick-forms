...
| `field_type` | `string` | Yes | - | Must be 'radio' for this field type |
...
| `values` | `options` | Yes | `[{"label":"Option 1","value":"1","default":false},{"label":"Option 2","value":"2","default":false},{"label":"Option 3","value":"3","default":false}]` | Define the available radio button options |
...
**`field_type`** *(required)*
- Must be 'radio' for this field type
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "radio",
            "description": "Must be 'radio' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "values": {
            ...
            "description": "Define the available radio button options",
            "tab": "options"
        },
        "source_url": {
            "type": "text",
