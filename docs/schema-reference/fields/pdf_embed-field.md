...
| `field_type` | `string` | Yes | - | Must be 'pdf_embed' for this field type |
...
| `input_mode` | `select` | No | `"url"` | Source |
| `pdf_url` | `text` | No | - | PDF URL |
| `pdf_upload` | `file` | No | - | Upload PDF |
| `pdf_preview` | `html` | No | - | Preview |
| `width` | `text` | No | `"100%"` | Width |
| `height` | `text` | No | `"600px"` | Height |
...
**`field_type`** *(required)*
- Must be 'pdf_embed' for this field type
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "pdf_embed",
            "description": "Must be 'pdf_embed' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
