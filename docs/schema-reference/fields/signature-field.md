...
| `field_type` | `string` | Yes | - | Must be 'signature' for this field type |
...
| `canvas_width` | `text` | No | `"500"` | Width of the signature canvas (supports px, %, rem, em, etc.) |
| `canvas_height` | `text` | No | `"200"` | Height of the signature canvas (supports px, %, rem, em, etc.) |
| `pen_color` | `color` | No | `"#000000"` | Color of the signature pen |
| `background_color` | `color` | No | `"#ffffff"` | Background color of the canvas |
...
**`field_type`** *(required)*
- Must be 'signature' for this field type
...
**`canvas_width`**
- Width of the signature canvas (supports px, %, rem, em, etc.)

**`canvas_height`**
- Height of the signature canvas (supports px, %, rem, em, etc.)
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "signature",
            "description": "Must be 'signature' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "canvas_width": {
            ...
            "storage": "json_column",
            "default": "500",
            "description": "Width of the signature canvas (supports px, %, rem, em, etc.)",
            "tab": "options"
        },
        "canvas_height": {
            "type": "text",
            ...
            "storage": "json_column",
            "default": "200",
            "description": "Height of the signature canvas (supports px, %, rem, em, etc.)",
            "tab": "options"
        },
        "pen_color": {
            "type": "color",
            ...
            "storage": "json_column",
            "default": "#000000",
            "description": "Color of the signature pen",
            "tab": "options"
        },
        "background_color": {
            "type": "color",
