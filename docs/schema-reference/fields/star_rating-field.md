...
| `field_type` | `string` | Yes | - | Must be 'star_rating' for this field type |
...
| `max_stars` | `number` | No | `"5"` | Number of stars to display (e.g., 5 for 5-star rating) |
...
**`field_type`** *(required)*
- Must be 'star_rating' for this field type
...
**`max_stars`**
- Number of stars to display (e.g., 5 for 5-star rating)
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "star_rating",
            "description": "Must be 'star_rating' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "max_stars": {
            ...
            "storage": "json_column",
            "default": "5",
            "description": "Number of stars to display (e.g., 5 for 5-star rating)",
            "tab": "options"
        }
    },
    "validation_rules": {
