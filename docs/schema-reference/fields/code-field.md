...
| `field_type` | `string` | Yes | - | Must be 'code' for this field type |
...
| `code_content` | `ace_editor` | No | - | Enter HTML, CSS, or JavaScript code to display/execute |
...
**`field_type`** *(required)*
- Must be 'code' for this field type
...
**`code_content`**
- Enter HTML, CSS, or JavaScript code to display/execute
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "code",
            "description": "Must be 'code' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "code_content": {
            ...
            "storage": "json_column",
            "default": null,
            "description": "Enter HTML, CSS, or JavaScript code to display\/execute",
            "tab": "basic"
        }
    },
    "validation_rules": {
