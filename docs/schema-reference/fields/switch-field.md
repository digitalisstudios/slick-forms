...
| `field_type` | `string` | Yes | - | Must be 'switch' for this field type |
...
| `show_labels` | `switch` | No | `true` | Display text labels next to the switch |
| `on_label` | `text` | No | `"On"` | Text shown when switch is enabled |
| `off_label` | `text` | No | `"Off"` | Text shown when switch is disabled |
...
**`field_type`** *(required)*
- Must be 'switch' for this field type
...
**`show_labels`**
- Display text labels next to the switch

**`on_label`**
- Text shown when switch is enabled

**`off_label`**
- Text shown when switch is disabled
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "switch",
            "description": "Must be 'switch' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "show_labels": {
            ...
            "storage": "json_column",
            "default": true,
            "description": "Display text labels next to the switch",
            "tab": "options"
        },
        "on_label": {
            "type": "text",
            ...
            "storage": "json_column",
            "default": "On",
            "description": "Text shown when switch is enabled",
            "tab": "options"
        },
        "off_label": {
            "type": "text",
            ...
            "storage": "json_column",
            "default": "Off",
            "description": "Text shown when switch is disabled",
            "tab": "options"
        }
    },
    "validation_rules": {
