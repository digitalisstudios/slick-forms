...
| `field_type` | `string` | Yes | - | Must be 'header' for this field type |
...
| `heading_level` | `select` | No | `"h3"` | Heading Level |
| `class_name` | `text` | No | - | Additional CSS classes for styling |
...
**`field_type`** *(required)*
- Must be 'header' for this field type
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "header",
            "description": "Must be 'header' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
