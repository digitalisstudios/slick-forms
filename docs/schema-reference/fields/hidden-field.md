...
| `field_type` | `string` | Yes | - | Must be 'hidden' for this field type |
...
| `default_value` | `text` | No | - | Pre-filled value for this hidden field |
...
**`field_type`** *(required)*
- Must be 'hidden' for this field type
...
**`default_value`**
- Pre-filled value for this hidden field
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "hidden",
            "description": "Must be 'hidden' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "default_value": {
            ...
            "storage": "json_column",
            "default": null,
            "description": "Pre-filled value for this hidden field",
            "tab": "options"
        }
    },
    "validation_rules": {
