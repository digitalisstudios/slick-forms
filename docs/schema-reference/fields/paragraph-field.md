...
| `field_type` | `string` | Yes | - | Must be 'paragraph' for this field type |
...
| `content` | `wysiwyg` | No | - | Use the WYSIWYG editor to format your paragraph content |
...
**`field_type`** *(required)*
- Must be 'paragraph' for this field type
...
**`content`**
- Use the WYSIWYG editor to format your paragraph content
...
```json
{
    ...
    "properties": {
        ...
        "field_type": {
            ...
            "storage": "column",
            "value": "paragraph",
            "description": "Must be 'paragraph' for this field type"
        },
        "validation_rules": {
            "type": "mixed",
            "storage": "column",
        ...
        "content": {
            ...
            "storage": "json_column",
            "default": null,
            "description": "Use the WYSIWYG editor to format your paragraph content",
            "tab": "basic"
        }
    },
    "validation_rules": {
